...
export default function AuthToolbar(props) {
    ...
    const [sifremiUnuttumModalShow, sifremiUnuttumSetModalShow] = React.useState(false);
    ...
    const profilimHandleClose = () => {
        setAnchorEl(null);
        history.push('/profilimPage');
    };

    const guvenlikHandleClose = () =>{
        setAnchorEl(null);
    }

    const ilanlarimHandleClose = () =>{
        setAnchorEl(null);
    }
    return (
            ...
            <nav className='toolbar__navigation'>
                ...
                <div className='toolbar__toggle-button'>
                    ...
                    <Button aria-controls="simple-menu" aria-haspopup="true" onClick={handleClick} style={{color:'white'}}>
                        <RiProfileLine style={{width:30,height:30,color:'white'}}/>&nbsp;&nbsp; Profilim
      </Button>
                        <Menu
                            id="simple-menu"
                            anchorEl={anchorEl}
                            ...
                            onClose={handleClose}
                        >
                            <MenuItem onClick={profilimHandleClose} href='/profilim'><RiProfileLine style={{width:30,height:30,color:'#cb397a'}}/>&nbsp;&nbsp;Profilim</MenuItem>
                            <MenuItem onClick={guvenlikHandleClose}><RiSettings3Line style={{width:30,height:30,color:'#cb397a'}}/>&nbsp;&nbsp;Güvenlik Ayarları</MenuItem>
                            <MenuItem onClick={ilanlarimHandleClose}><RiCheckDoubleLine style={{width:30,height:30,color:'#cb397a'}}/>&nbsp;&nbsp;İlanlarım</MenuItem>
                        </Menu>
                    </div>
                </div>
                    ...
                    <ul>
                        ...
                        <div className='row'>
                            <div className='col-2-lg dropdown'>
                                <li className='menu_link dropbtn'><ShoppingCartIcon /> &nbsp;&nbsp;Ürünler</li>
