...
const errorFunction = (urunID) => {

 
  alert(urunID)
}

export default class OneCikanlarSection extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div style={{ marginTop: 50, paddingRight: 40, paddingLeft: 40 }}>
        <p style={{ fontSize: 28 }}>Öne Çıkanlar<span style={{ float: 'right', fontSize: 10 }}><Button color="light" style={{ fontSize: 10 }}>Daha Fazlasını Gör ></Button></span></p>
